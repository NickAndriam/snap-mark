...
export default function ScoreButtons({ score, getScore }: ScoreButtonsProps) {
  return (
    <div className="text-2xl flex flex-col items-center justify-center gap-2 lg:gap-5 opacity-80">
      <p
        className="text-4xl pressed cursor-pointer"
        onClick={() => getScore(1)}
      >
        +
      </p>
...
const Number = ({
  ...
  return (
    <div
      className="border border-white/20 w-8 h-8 rounded-full text-lg flex items-center justify-center pressed cursor-pointer"
      onClick={onClick}
    >
